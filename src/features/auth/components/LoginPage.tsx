  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900">
        ...
        <div className="absolute top-0 left-0 w-72 h-72 bg-gradient-to-br from-yellow-400/10 to-orange-500/10 rounded-full"></div>
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-gradient-to-tl from-blue-400/10 to-purple-500/10 rounded-full"></div>
      </div>
        ...
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="text-center mb-6">
            <div className="relative inline-block mb-4">
              <div className="absolute -inset-2 bg-gradient-to-r from-yellow-400/20 to-orange-500/20 rounded-full"></div>
          ...
          <div className="relative group">
            <div className="absolute -inset-1 bg-gradient-to-r from-yellow-400/20 via-orange-500/20 to-pink-500/20 rounded-3xl opacity-30"></div>
            <Card className="relative bg-white/15 backdrop-blur-2xl border border-white/30 shadow-2xl rounded-3xl overflow-hidden">
              ...
              <CardContent className="relative z-10 px-6 pb-6">
                <form onSubmit={handleLogin} className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      <Input
                        ...
                        className="h-12 bg-white/10 border-white/20 text-white placeholder:text-white/50 focus:bg-white/20 focus:border-white/40 rounded-xl pl-4 pr-12"
                      />
                    ...
                    <label className="flex items-center space-x-3 cursor-pointer group">
                      <div className="relative">
                        <input
                          ...
                          className="sr-only"
                        />
                        <div className={`w-5 h-5 rounded-md border-2 ${rememberMe ? 'bg-gradient-to-r from-yellow-400 to-orange-500 border-yellow-400' : 'border-white/40 bg-white/10'}`}>
                          {rememberMe && (
                  ...
                  <Button 
                    type="submit" 
                    className="w-full h-12 bg-gradient-to-r from-yellow-400 to-orange-500 text-black font-bold rounded-2xl shadow-xl relative overflow-hidden group mt-6" 
                    disabled={isLoading}
                  >
