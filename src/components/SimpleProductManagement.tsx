...
export const SimpleProductManagement: React.FC<SimpleProductManagementProps> = ({ onBack, onNavigate }) => {
  ...
  return (
    <PageLayout>
      <PageHeader 
        ...
        description="Manage product catalog, categories, pricing, and variants"
        onBack={onBack}
