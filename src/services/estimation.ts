...
<body>
    <div class="invoice-container">
        <table class="invoice-table">
            ...
            <tr style="font-weight: bold">
                <td style="text-align: left; font-size: 12px; width: 20%;" colspan="2">EST-No: ${estimation.estimationNumber}</td>
                <td colspan="6" style="text-align: center; width: 60%;"><span class="estimation-badge" style="font-size: 12px; padding: 3px 8px; white-space: nowrap; display: inline-block;">Price Estimation</span></td>
                <td colspan="2" style="text-align: right; font-size: 12px; white-space: nowrap; width: 20%;"></td>
            </tr>
            ...
            <tr>
                <td style="text-align: left; border-right: 1px solid #000; border-bottom: 1px solid #000; padding: 2px; font-size: 12px; width: 50%;" colspan="5"><strong>Name:</strong> ${estimation.customer.name}</td>
                <td style="text-align: left; border-bottom: 1px solid #000; padding: 2px; font-size: 12px; width: 50%;" colspan="5"><strong>Date:</strong> ${new Date(estimation.date).toLocaleDateString('en-GB')}</td>
            </tr>
            <tr><td style="text-align: left; border-bottom: 1px solid #000; padding: 2px; font-size: 12px;" colspan="10"><strong>Customer Details:</strong> ${estimation.customer.address}</td></tr>
            <tr>
